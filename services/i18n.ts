...
export const translations = {
  en: {
    ...
    settings: {
      ...
      duitNowDisclaimer: 'Open your banking or e-wallet app, select DuitNow/Transfer, and enter the ID or Phone Number provided above.',
  ...
  zh: {
    ...
    settings: {
      ...
      duitNowId: '100819712653',
      tngId: '+60 187807388',
      transferVia: '即时转账 (马来西亚)',
      duitNowCopy: '复制 DuitNow ID',
      tngCopy: '复制 TNG 号码',
      paypalId: 'Vyncuslim vyncuslim',
      paypalLink: 'https://paypal.me/vyncuslim',
      paypalCopy: '复制 PayPal 链接',
      duitNowDisclaimer: '请打开您的银行或电子钱包 App，选择 DuitNow/转账，并输入上方提供的 ID 或手机号码。',
      dataManagement: '数据管理',
      manualSync: '手动同步',
      lastSync: '最后同步',
      never: '从不',
      ...
      about: '关于 SomnoAI',
      thankYouTitle: '收到捐助',
      thankYouMsg: '您的支持使实验室引擎得以在线运行。感谢您为数字健康研究提供动力。',
      closeReceipt: '返回实验室'
    },
    dataEntry: {
      title: '手动注入终端',
    ...
    about: {
      title: '关于实验室',
      mission: '我们的使命',
      missionText: '通过边缘计算和共情的 AI 实现高保真睡眠科学的普及。',
      tech: 'AI 技术',
      techText: '由 Gemini 3 系列模型驱动。',
      vision: '愿景',
      visionText: '让睡眠不再是一个黑匣子。'
    }
  }
};