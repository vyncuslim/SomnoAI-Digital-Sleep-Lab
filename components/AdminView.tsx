...
import { 
  ...
  List, Unlock, Mail, ActivitySquare, MessageSquare,
  AlertTriangle, Database, Search, ShieldX, Lightbulb, Sparkles,
...
export const AdminView: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [uRes, tRes, aRes, rRes, fRes] = await Promise.allSettled([
        adminApi.getUsers(),
