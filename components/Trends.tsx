...
import { 
  ...
  BrainCircuit, FileText, Loader2, Sparkles, ChevronRight, Binary, Clock, BarChart3
} from 'lucide-react';
  ...
  if (active && payload && payload.length) {
    ...
    return (
      <motion.div 
        ...
        className="bg-slate-950/90 backdrop-blur-xl border border-indigo-500/30 p-5 rounded-2xl shadow-2xl min-w-[200px] space-y-4"
      >
        ...
        <div className="space-y-1">
          <p className="text-[9px] font-black text-slate-400 uppercase tracking-tighter">Sleep Quality Score</p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-1">
          <div className="space-y-1">
            <p className="text-[8px] font-black uppercase text-indigo-400">Deep</p>
            <p className="text-sm font-mono text-white">{data.deepRatio}%</p>
          </div>
          <div className="space-y-1">
            <p className="text-[8px] font-black uppercase text-purple-400">REM</p>
            <p className="text-sm font-mono text-white">{data.remRatio}%</p>
          </div>
        </div>
      ...
      {!summary ? (
        ...
        <GlassCard className="p-8 border-indigo-500/40 bg-indigo-500/[0.02] space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setSummary(null)} className="text-[8px] font-black text-slate-600 uppercase hover:text-white">Dismiss</button>
          </div>
