...
if (rootElement) {
  try {
    ...
    // Provide user-friendly DOM fallback
    rootElement.innerHTML = `
      <div style="height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: sans-serif; text-align: center; color: #0f172a; padding: 40px; background: #ffffff;">
        <div style="width: 64px; height: 64px; border-radius: 50%; box-shadow: inset 16px 0 0 0 #4f46e5; margin-bottom: 32px;"></div>
        <h1 style="color: #4f46e5; font-style: italic; font-weight: 900; letter-spacing: -0.05em; font-size: 2.5rem; margin-bottom: 16px;">TERMINAL OFFLINE</h1>
