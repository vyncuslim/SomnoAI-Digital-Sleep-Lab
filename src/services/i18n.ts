...
export const translations: Record<Language, any> = {
  en: {
    auth: {
      ...
      blocked: 'You have violated the terms. If you have any questions, please contact admin@digitalsleeplab.com',
  ...
  zh: {
    auth: {
      ...
      blocked: '你违反了条款。如有问题，请联系 admin@digitalsleeplab.com',
