...
Questions regarding open-source notices or attribution matters may be sent through our legal or technical contact channel.`
    ...
    "children-privacy": {
      ...
      content: `SomnoAI Digital Sleep Lab is committed to protecting the privacy and safety of children and minors. This Children’s Privacy notice explains how we approach information relating to children, minors, and parental or guardian rights in connection with our website, products, services, and related digital channels.
...
有关开源通知或归属事项的问题可以通过我们的法律或技术联系渠道发送。`
    ...
    "children-privacy": {
      title: "儿童隐私政策",
      subtitle: "保护未成年人",
      content: `SomnoAI Digital Sleep Lab 致力于保护儿童和未成年人的隐私和安全。本儿童隐私通知解释了我们如何处理与我们的网站、产品、服务和相关数字渠道相关的儿童、未成年人以及父母或监护人权利的信息。

**1. 不面向 13 岁以下儿童**
我们的服务主要不面向 13 岁以下的儿童。在适用法律要求的情况下，未经适当的父母或法定监护人同意，我们不会故意直接收集 13 岁以下儿童的个人信息。
