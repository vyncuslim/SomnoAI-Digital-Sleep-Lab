...
export const About: React.FC<AboutProps> = ({ lang }) => {
  ...
  return (
    <MarketingPageTemplate
      title={lang === 'zh' ? "关于 SomnoAI Digital Sleep Lab" : "About SomnoAI Digital Sleep Lab"}
      subtitle={lang === 'zh' ? "SomnoAI Digital Sleep Lab 是一个以研究为导向的技术项目，致力于探索人工智能和先进数据分析如何加深对人类睡眠的理解。" : "SomnoAI Digital Sleep Lab is a research-driven technology initiative dedicated to exploring how artificial intelligence and advanced data analysis can deepen the understanding of human sleep."}
