  ...
  return (
    <PageLayout>
      <Hero 
        ...
        subtitle={lang === 'zh' ? "SomnoAI Digital Sleep Lab 在旨在保护平台及其用户的综合法律框架下运营。本节概述了我们的法律地位和管理原则。" : "SomnoAI Digital Sleep Lab operates under a comprehensive legal framework designed to protect both the platform and its users. This section provides an overview of our legal standing and governing principles."} 
      />
          ...
          <div className="lg:col-span-2 space-y-12">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <Link to="/legal/terms-of-service"><Card title={lang === 'zh' ? "服务条款" : "Terms of Service"} description={lang === 'zh' ? "使用 SomnoAI Digital Sleep Lab 平台的规则和准则。" : "Rules and guidelines for using the SomnoAI Digital Sleep Lab platform."} icon={<FileText />} className="cursor-pointer hover:bg-slate-800/50 h-full" /></Link>
