...
export const MediaResources: React.FC<MediaResourcesProps> = ({ lang }) => {
  return (
    ...
    >
      <Section>
        <section className="media-resources prose prose-invert max-w-none text-slate-300">
          ...
          {/* Brand Assets */}
          <details className="group bg-white/5 rounded-xl border border-white/10 overflow-hidden mb-4">
            ...
            <div className="p-6 pt-0 border-t border-white/10 mt-4">
              <h3>Logos, Colors, and Brand Guidelines</h3>
              <p>
          ...
          <details className="group bg-white/5 rounded-xl border border-white/10 overflow-hidden mb-4">
            ...
            <div className="p-6 pt-0 border-t border-white/10 mt-4">
              <h3>SomnoAI Digital Sleep Lab Overview</h3>
              <p>
              ...
              <ul>
                <li><strong>Project Name:</strong> SomnoAI Digital Sleep Lab</li>
                <li><strong>Focus Area:</strong> Artificial Intelligence and Sleep Data Analysis</li>
                <li><strong>Technology:</strong> Machine Learning, Behavioral Data Processing</li>
                <li><strong>Platform Type:</strong> Digital Research and Analytical Platform</li>
                <li><strong>Primary Objective:</strong> Explore computational interpretation of sleep patterns</li>
              </ul>
              <p>
